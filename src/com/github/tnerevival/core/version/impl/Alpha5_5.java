...
public class Alpha5_5 extends Version {
  ...
  public void update(double version, String type) {
    ...
    if(version >= 5.2 && version <= 5.4) {
      ...
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `balance` VARCHAR(40)");
      table = prefix + "_BANK_BALANCES";
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `balance` VARCHAR(40)");
      table = prefix + "_TRANSACTIONS";
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `trans_cost` VARCHAR(40)");
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `trans_oldBalance` VARCHAR(40)");
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `trans_balance` VARCHAR(40)");
      table = prefix + "_SIGN_OFFERS";
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `offer_buy` VARCHAR(40)");
      sql().executeUpdate("ALTER TABLE `" + table + "` MODIFY `offer_sell` VARCHAR(40)");
      return;
    }
  ...
  public void createTables(String type) {
    ...
    if(type.equalsIgnoreCase("mysql")) {
      ...
      mysql().executeUpdate("CREATE TABLE IF NOT EXISTS `" + table + "` (" +
          ...
          "`trans_cost` VARCHAR(40)," +
          "`trans_oldBalance` VARCHAR(40)," +
          "`trans_balance` VARCHAR(40)," +
