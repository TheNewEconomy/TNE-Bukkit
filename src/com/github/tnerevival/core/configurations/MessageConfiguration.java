...
public class MessageConfiguration extends Configuration {
	...
	public void load(FileConfiguration configurationFile) {
		...
		configurations.put("Messages.Objects.CraftingCharged", "<white> You were charged $amount for crafting $stack_size \"$item\".");
		configurations.put("Messages.Objects.CraftingPaid", "<white> You were given $amount for crafting $stack_size \"$item\".");
		configurations.put("Messages.Objects.SmeltingCharged", "<white> You were charged $amount for smelting $stack_size \"$item\".");
		configurations.put("Messages.Objects.SmeltingPaid", "<white> You were given $amount for smelting $stack_size \"$item\".");
		configurations.put("Messages.Objects.EnchantingCharged", "<white> You were charged $amount for enchanting $stack_size \"$item\".");
		configurations.put("Messages.Objects.EnchantingPaid", "<white> You were given $amount for enchanting $stack_size \"$item\".");
		configurations.put("Messages.Objects.BrewingCharged", "<white> You were charged $amount for brewing $stack_size \"$item\".");
		configurations.put("Messages.Objects.BrewingPaid", "<white> You were given $amount for brewing $stack_size \"$item\".");
		configurations.put("Messages.Objects.MiningCharged", "<white> You were charged $amount for mining one \"$name\" block.");
		configurations.put("Messages.Objects.MiningPaid", "<white> You were given $amount for mining one \"$name\" block.");
		configurations.put("Messages.Objects.PlacingCharged", "<white> You were charged $amount for placing one \"$name\" block.");
		configurations.put("Messages.Objects.PlacingPaid", "<white> You were given $amount for placing one \"$name\" block.");
		configurations.put("Messages.Objects.ItemUseCharged", "<white> You were charged $amount for using item \"$name\".");
		configurations.put("Messages.Objects.ItemUsePaid", "<white> You were given $amount for using item \"$name\".");
		configurations.put("Messages.Objects.PotionUseCharged", "<white> You were charged $amount for using a \"$name\" potion.");
		configurations.put("Messages.Objects.PotionUsePaid", "<white> You were given $amount for using a \"$name\" potion.");
