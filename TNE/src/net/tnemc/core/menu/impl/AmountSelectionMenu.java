...
public class AmountSelectionMenu extends Menu {
  ...
  public Inventory buildInventory(Player player) {
    ...
    icons.put(0, new Icon(0, Material.SKULL_ITEM, ChatColor.stripColor(IDFinder.getUsername(playerName.toString()))));
    ...
    icons.put(8, new Icon(8, Material.SKULL_ITEM, ChatColor.stripColor(IDFinder.getUsername(playerName.toString()))));
