 ...
 */
public class ItemCompatibility18 implements ItemCompatibility {
  @Override
  public ItemStack build(String material) {
    ...
    switch(material.toUpperCase()) {
      ...
      case "WHITE_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("WHITE_STAINED_GLASS_PANE"), 1);
      case "BLACK_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("BLACK_STAINED_GLASS_PANE"), 1);
      case "RED_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("RED_STAINED_GLASS_PANE"), 1);
      case "GREEN_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("GREEN_STAINED_GLASS_PANE"), 1);
      case "YELLOW_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("YELLOW_STAINED_GLASS_PANE"), 1);
      case "BLUE_STAINED_GLASS_PANE":
        return new ItemStack(Material.matchMaterial("BLUE_STAINED_GLASS_PANE"), 1);
      ...
      case "PLAYER_HEAD":
        return new ItemStack(Material.matchMaterial("SKULL_ITEM"), 1);
      case "BLACK_WOOL":
        return new ItemStack(Material.matchMaterial("BLACK_WOOL"), 1);
      case "GREEN_WOOL":
        return new ItemStack(Material.matchMaterial("GREEN_WOOL"), 1);
      case "RED_WOOL":
        return new ItemStack(Material.matchMaterial("RED_WOOL"), 1);
      case "IRON_NUGGET":
