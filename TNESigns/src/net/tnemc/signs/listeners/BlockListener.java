...
public class BlockListener implements Listener {
  ...
  public void onBlockBreakEvent(final BlockBreakEvent event) {
    final TNESign sign = (event.getBlock().getType().equals(Material.SIGN_POST) || event.getBlock().getType().equals(Material.WALL_SIGN))?
      SignsData.loadSign(event.getBlock().getLocation())
      : SignsData.loadSignAttached(event.getBlock().getLocation());

    if(sign != null) {
      final Sign signBlock = (event.getBlock().getType().equals(Material.SIGN_POST) || event.getBlock().getType().equals(Material.WALL_SIGN))?
  ...
  public void onBlockBurn(final BlockBurnEvent event) {
    final Sign sign = (event.getBlock().getType().equals(Material.SIGN_POST) || event.getBlock().getType().equals(Material.WALL_SIGN))?
        (Sign)event.getBlock().getState() : SignsManager.getAttachedSign(event.getBlock());
