...
import net.tnemc.signs.signs.impl.toitem.menu.preview.BackIcon;
import net.tnemc.signs.signs.impl.toitem.menu.preview.DisplayIcon;
...
public class ShulkerPreviewMenu extends Menu {
  public ShulkerPreviewMenu() {
    ...
    icons.put(31, new BackIcon(31, "shop_offer_menu"));
  }
