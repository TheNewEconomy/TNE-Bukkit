...
public class OracleModule extends Module {

  @Override
  public void load(TNE tne, String version) {
    TNE.logger().info("Oracle Module loaded!");
  }

  @Override
  public void unload(TNE tne) {
    TNE.logger().info("Oracle Module unloaded!");
  }
  ...
  public Map<String, Class<? extends TNEDataProvider>> registerProviders() {
    ...
    providers.put("oracle", OracleProvider.class);
    return providers;
  }
}
