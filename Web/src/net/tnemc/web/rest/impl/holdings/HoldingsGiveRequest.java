 ...
 */
public class HoldingsGiveRequest implements IRequest {
  @Override
  ...
  public String work(Request request, Response response) {
    ...
    return new Gson().toJson(new RestResponse(RestResponseType.convert(AccountService.addHoldings(requestHoldings.getIdentifier(), requestHoldings.getWorld(), requestHoldings.getCurrency(), amount))));
  }
}