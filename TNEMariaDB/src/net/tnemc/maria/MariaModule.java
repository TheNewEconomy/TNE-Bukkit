...
public class MariaModule extends Module {

  @Override
  public void load(TNE tne, String version) {
    TNE.logger().info("Maria Module loaded!");
  }

  @Override
  public void unload(TNE tne) {
    TNE.logger().info("Maria Module unloaded!");
  }
  ...
  public Map<String, Class<? extends TNEDataProvider>> registerProviders() {
    ...
    providers.put("maria", MariaProvider.class);
    return providers;
  }
}
