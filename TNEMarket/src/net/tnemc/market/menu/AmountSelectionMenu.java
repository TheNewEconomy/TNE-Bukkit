...
import net.tnemc.market.menu.amountselection.AddIcon;
import net.tnemc.market.menu.amountselection.CancelIcon;
import net.tnemc.market.menu.amountselection.ConfirmIcon;
import net.tnemc.market.menu.amountselection.ResetIcon;
...
public class AmountSelectionMenu extends Menu {
  public AmountSelectionMenu(String name) {
    super(name, "Cost Amount Selection", 5);
  }
