...
public class DiscordConfiguration extends Configuration {
  ...
  public CommentedConfiguration getConfiguration() {
    return DiscordModule.instance().getDiscordFileConfiguration();
  }

  @Override
  public List<String> node() {
    return Collections.singletonList("Discord");
  }

  @Override
  public File getFile() {
    return DiscordModule.instance().getDiscord();
  }

  @Override
  public void load(CommentedConfiguration configurationFile) {
    if(DiscordModule.instance().getDiscord().exists()) DiscordModule.instance().saveConfigurations();
