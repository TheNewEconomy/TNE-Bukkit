 ...
 */
public class DiscordDecoBalanceCommand extends DiscordCommand {
  @Override
  public String name() {
    return "balance";
  }
  ...
  public EmbedBuilder help() {
    ...
    builder.setTitle("!deco balance");
    builder.setDescription("Usage: !deco balance");
    builder.addField("Description", "Checks your balance.", false);
