 ...
 */
public class DiscordDecoPayCommand extends DiscordCommand {
  @Override
  public String name() {
    return "pay";
  }
  ...
  public EmbedBuilder help() {
    ...
    builder.setTitle("!deco pay");
    builder.setDescription("Usage: !deco pay <discord id> <amount>");
    builder.addField("Description", "Pays a discord user an amount from your own funds.", false);
