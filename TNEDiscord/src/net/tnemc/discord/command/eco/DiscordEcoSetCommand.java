...
public class DiscordEcoSetCommand extends DiscordCommand {
  ...
  public EmbedBuilder help() {
    ...
    builder.setTitle("!eco set");
    builder.setDescription("Usage: !eco set <discord id> <amount>");
    builder.addField("Description", "Sets the balance of the specified Minecraft user to the amount.", false);
