...
public class DiscordEcoBalanceOtherCommand extends DiscordCommand {
  ...
  public EmbedBuilder help() {
    ...
    builder.setTitle("!eco balanceother");
    builder.setDescription("Usage: !eco balanceother <discord id>");
    builder.addField("Description", "Checks another Minecraft user's balance.", false);
