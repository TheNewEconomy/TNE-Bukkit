...
public class DiscordEcoGiveCommand extends DiscordCommand {
  ...
  public EmbedBuilder help() {
    ...
    builder.setTitle("!eco give");
    builder.setDescription("Usage: !eco give <discord id> <amount>");
    builder.addField("Description", "Gives a Minecraft user a certain amount of funds.", false);
