...
public class Blings extends Converter {
  ...
  public File dataFolder() {
    return new File(TNE.instance().getDataFolder(), "../Blings/config.yml");
  }
  ...
  public void yaml() throws InvalidDatabaseImport {
    ...
    if(accountSection != null) {
      ...
      for(String uuid : accounts) {
        ...
        ConversionModule.convertedAdd(uuid, TNE.instance().defaultWorld, cur.name(), new BigDecimal(config.getString("Money." + uuid)));
      }
    }
  }
}
