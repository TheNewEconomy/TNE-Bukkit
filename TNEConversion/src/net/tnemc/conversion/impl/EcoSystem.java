...
public class EcoSystem extends Converter {
  ...
  public File dataFolder() {
    return new File(TNE.instance().getDataFolder(), "../EcoSystem/playerData.yml");
  }
  ...
  public void yaml() throws InvalidDatabaseImport {
    ...
    if(accountSection != null) {
      ...
      for(String uuid : accounts) {
        ...
        ConversionModule.convertedAdd(uuid, TNE.instance().defaultWorld, cur.name(), new BigDecimal(config.getString("Players." + uuid + ".Bal")));
      }
    }
  }
}
