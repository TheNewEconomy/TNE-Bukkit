...
import net.tnemc.bounty.menu.amountselection.AddIcon;
import net.tnemc.bounty.menu.amountselection.CancelIcon;
import net.tnemc.bounty.menu.amountselection.ConfirmIcon;
import net.tnemc.bounty.menu.amountselection.ResetIcon;
...
public class AmountSelectionMenu extends Menu {
  public AmountSelectionMenu(String name) {
    super(name, "Bounty Amount Selection", 6);
  }
