 ...
 */
public class BountyConfiguration extends Configuration {

  @Override
  public CommentedConfiguration getConfiguration() {
    return BountyModule.instance().getBountyFileConfiguration();
  }

  @Override
  public List<String> node() {
    return Collections.singletonList("Bounty");
  }

  @Override
  public File getFile() {
    return BountyModule.instance().getBounty();
  }

  @Override
  public void load(CommentedConfiguration configurationFile) {
    if(BountyModule.instance().getBounty().exists()) BountyModule.instance().saveConfigurations();
