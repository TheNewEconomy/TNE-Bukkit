...
public class FlatFileModule extends Module {

  @Override
  public void load(TNE tne, String version) {
    tne.logger().info("FlatFile Module loaded!");
  }

  @Override
  public void unload(TNE tne) {
    tne.logger().info("FlatFile Module unloaded!");
  }
  ...
  public Map<String, Class<? extends TNEDataProvider>> registerProviders() {
    ...
    providers.put("flatfile", FlatFileProvider.class);
    return providers;
  }
}
